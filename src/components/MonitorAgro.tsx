...
const MonitorAgro: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"producao" | "recursos" | "economia" | "pessoas">("producao");

  // ESTADO PARA ARMAZENAR OS DADOS DO MAPA (GEOJSON)
  const [geoData, setGeoData] = useState<any>(null);

  // CARREGAMENTO DOS DADOS DO MAPA VIA PUBLIC FOLDER
  useEffect(() => {
    fetch("/geoBoundaries-AGO-ADM1_simplified.geojson")
      .then((res) => {
        if (!res.ok) throw new Error("Falha ao carregar o arquivo GeoJSON");
        return res.json();
      })
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex flex-wrap gap-2 p-2 bg-[#13192B] rounded-2xl border border-white/5 backdrop-blur-xl">
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Produção</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Recursos</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Economia</span>
          </button>
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Pessoas</span>
          </button>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto min-h-[50vh]">
        ...
        {activeTab === 'recursos' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* MAPA REAL: Passando os dados carregados do GeoJSON */}
            <RealMap geoData={geoData} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section className="bg-[#13192B] p-6 rounded-3xl border border-white/5 transition-all duration-500 hover:border-blue-500/40 hover:shadow-[0_30px_50px_-15px_rgba(37,99,235,0.3)]">
              ...
              <div className="flex flex-col justify-center items-center py-8">
                ...
                <p className="text-[10px] text-[#8A91A5] uppercase tracking-[0.2em] font-bold">Rendimento Médio por Hectare</p>
                <div className="mt-8 w-full space-y-3">
                  ...
                  <p className="text-[9px] text-[#8A91A5] italic text-center">80% da meta atingida nesta campanha</p>
                </div>
              </div>
            </section>
          </div>
            ...
            <section className="bg-[#13192B] p-6 rounded-3xl border border-white/5 transition-all duration-500 hover:border-blue-500/40 hover:shadow-[0_30px_50px_-15px_rgba(37,99,235,0.3)]">
              ...
              <div className="space-y-4">
                <div className="bg-[#181D33]/40 p-4 rounded-2xl border border-white/[0.02]">
                  <p className="text-[10px] text-[#8A91A5] uppercase font-bold tracking-widest mb-3">Cobertura de Assistência</p>
                  <div className="flex items-end gap-2 mb-2">
                    <span className="text-3xl font-mono font-bold text-white">85</span>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-[#181D33]/60 p-3 rounded-xl border border-white/5">
                    <p className="text-[9px] uppercase text-[#8A91A5] mb-1">Visitas/Mês</p>
                    <p className="text-sm font-bold text-white">342</p>
                  </div>
                  <div className="bg-[#181D33]/60 p-3 rounded-xl border border-white/5">
                    <p className="text-[9px] uppercase text-[#8A91A5] mb-1">Formações</p>
                ...
                <div className="mt-2 p-3 bg-purple-500/5 border border-purple-500/10 rounded-xl flex items-center gap-3">
                  ...
                  <p className="text-[10px] text-[#8A91A5] italic">Sincronização activa (Offline-first)</p>
                </div>
              </div>
            </section>
          </div>
