...
export const AgroCard: React.FC<AgroCardProps> = ({ title, icon, data, badgeText, variant }) => {
  // Mapeamento das sombras específicas para manter o efeito "para a direita"
  // Aqua: usa Cyan-500 | Amber: usa Amber-500
  const shadowStyles = {
    aqua: "hover:border-cyan-500/40 hover:shadow-[25px_30px_50px_-15px_rgba(6,182,212,0.3)]",
    amber: "hover:border-amber-500/40 hover:shadow-[25px_30px_50px_-15px_rgba(245,158,11,0.3)]"
  };
